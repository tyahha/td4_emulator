...
var _tyahha$td4_emulator$Messages$Clock10Hz = function (a) {
	return {ctor: 'Clock10Hz', _0: a};
};
var _tyahha$td4_emulator$Messages$Clock1Hz = function (a) {
	return {ctor: 'Clock1Hz', _0: a};
};
		...
		A2(
			_elm_lang$core$Basics_ops['++'],
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Program Memory'),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			},
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('TD4 Emulator'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('implemented with elm '),
						_1: {
							ctor: '::',
							_0: A2(
								_elm_lang$html$Html$a,
...
var _tyahha$td4_emulator$Subscriptions$subscriptions = function (model) {
	var _p0 = model.clockMode;
	switch (_p0.ctor) {
		case 'OneHz':
			return A2(_elm_lang$core$Time$every, _elm_lang$core$Time$second, _tyahha$td4_emulator$Messages$Clock1Hz);
		case 'TenHz':
			return A2(_elm_lang$core$Time$every, 100 * _elm_lang$core$Time$millisecond, _tyahha$td4_emulator$Messages$Clock10Hz);
		default:
			return _elm_lang$core$Platform_Sub$none;
	}
};
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _tyahha$td4_emulator$Main$main !== 'undefined') {
    _tyahha$td4_emulator$Main$main(Elm['Main'], 'Main', undefined);
}
