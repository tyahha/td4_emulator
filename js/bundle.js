...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ImmediateData__ = __webpack_require__(3);


class OperationInput {
  constructor(carry, clockCount, data) {
    this.carry = carry;
    this.clockCount = clockCount;
    this.data = data;
  }
}
/* harmony export (immutable) */ __webpack_exports__["a"] = OperationInput;
...
class OperationOutput {
  constructor(carry, clockCount) {
    this.carry = carry;
    this.clockCount = clockCount;
  }
}
/* harmony export (immutable) */ __webpack_exports__["a"] = OperationOutput;
...
/* harmony export (immutable) */ __webpack_exports__["a"] = ImmediateData;
...
class Setting {
  ...
  constructor(clockMode, beep, memories) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__view_model_register_RegisterAggregationVM__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__view_model_rom_RomVM__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__view_model_clock_generator_ClockGeneratorVM__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__view_model_operation_ResetOperationVM__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__domain_operation_OperationAggregation__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__domain_operation_OperationInput__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__storage_parser_FileParser__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__storage_Setting__ = __webpack_require__(4);
...
const romVM = new __WEBPACK_IMPORTED_MODULE_2__view_model_rom_RomVM__["a" /* default */]();
const romDom = document.querySelector('.program-memory');
__WEBPACK_IMPORTED_MODULE_0_knockout___default.a.applyBindings(romVM, romDom);

const registerAggregationVM = new __WEBPACK_IMPORTED_MODULE_1__view_model_register_RegisterAggregationVM__["a" /* default */](newProgramCount => {
  romVM.nextStep(newProgramCount);
});
const registerDom = document.querySelector('.register');
__WEBPACK_IMPORTED_MODULE_0_knockout___default.a.applyBindings(registerAggregationVM, registerDom);

const operations = new __WEBPACK_IMPORTED_MODULE_5__domain_operation_OperationAggregation__["a" /* default */](registerAggregationVM.registerA, registerAggregationVM.registerB, registerAggregationVM.input, registerAggregationVM.output);

const clockGeneratorDom = document.querySelector('.clock-generator');
const clockGeneratorVM = new __WEBPACK_IMPORTED_MODULE_3__view_model_clock_generator_ClockGeneratorVM__["a" /* default */](() => {
  const currentLine = romVM.currentLine();
  const output = operations.run(currentLine.getOperationData(), new __WEBPACK_IMPORTED_MODULE_6__domain_operation_OperationInput__["a" /* default */](registerAggregationVM.carryFlag(), registerAggregationVM.programCounter.getValue(), currentLine.getImmediateData()));
...
__WEBPACK_IMPORTED_MODULE_0_knockout___default.a.applyBindings(clockGeneratorVM, clockGeneratorDom);
...
const resetOperationVM = new __WEBPACK_IMPORTED_MODULE_4__view_model_operation_ResetOperationVM__["a" /* default */](reset);
__WEBPACK_IMPORTED_MODULE_0_knockout___default.a.applyBindings(resetOperationVM, resetOperationDom);
        ...
        if (file) {
          ...
          reader.onload = ev => {
            if (typeof reader.result === 'string') {
              const parseResult = __WEBPACK_IMPORTED_MODULE_7__storage_parser_FileParser__["a" /* default */].fileToSetting(reader.result);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_knockout__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_knockout___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_knockout__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__RegisterVM__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__IOVM__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__BeepVM__ = __webpack_require__(9);





class RegisterAggregationVM {

  constructor(programCounterSbscriver) {
    this.registerA = new __WEBPACK_IMPORTED_MODULE_1__RegisterVM__["a" /* default */]('A', 0);
    this.registerB = new __WEBPACK_IMPORTED_MODULE_1__RegisterVM__["a" /* default */]('B', 0);
    this.carryFlag = __WEBPACK_IMPORTED_MODULE_0_knockout___default.a.observable(false);
    this.programCounter = new __WEBPACK_IMPORTED_MODULE_1__RegisterVM__["a" /* default */]('PC', 0, programCounterSbscriver);
    this.input = new __WEBPACK_IMPORTED_MODULE_2__IOVM__["a" /* default */]();
    this.output = new __WEBPACK_IMPORTED_MODULE_2__IOVM__["a" /* default */]();
    this.beep = new __WEBPACK_IMPORTED_MODULE_3__BeepVM__["a" /* default */]();
  }
...
/* harmony export (immutable) */ __webpack_exports__["a"] = RegisterAggregationVM;
...
class RegisterVM {
  ...
  constructor(name, value, subscriber) {
    this.name = name;
    this.value = __WEBPACK_IMPORTED_MODULE_0_knockout___default.a.observable(value);
    if (subscriber) {
      this.value.subscribe(subscriber);
    }
    this.display = __WEBPACK_IMPORTED_MODULE_0_knockout___default.a.computed(() => {
...
/* harmony export (immutable) */ __webpack_exports__["a"] = RegisterVM;
...
class Memory {
  constructor() {
    this.value = __WEBPACK_IMPORTED_MODULE_0_knockout___default.a.observable(false);
  }
}

function constructMemories() {
  return [new Memory(), new Memory(), new Memory(), new Memory()];
}
...
/* harmony export (immutable) */ __webpack_exports__["a"] = IOVM;
...
/* harmony export (immutable) */ __webpack_exports__["a"] = BeepVM;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__RomLineVM__ = __webpack_require__(11);
...
class RomVM {
    constructor() {
        this.lines = [];
        for (let i = 0; i < 16; i++) {
            this.lines.push(new __WEBPACK_IMPORTED_MODULE_0__RomLineVM__["a" /* default */](i));
        }
...
/* harmony export (immutable) */ __webpack_exports__["a"] = RomVM;
...
"use strict";
/* unused harmony export parseMemoryToNumber */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_knockout__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_knockout___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_knockout__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__RomCellVM__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__RomLineAddress__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__domain_ImmediateData__ = __webpack_require__(3);





function parseMemoryCellToNumber(cell) {
    return cell ? cell.value() ? 1 : 0 : 0;
}

function parseMemoryToNumber(memories) {
    return parseMemoryCellToNumber(memories[3]) << 3 | parseMemoryCellToNumber(memories[2]) << 2 | parseMemoryCellToNumber(memories[1]) << 1 | parseMemoryCellToNumber(memories[0]) << 0;
}

class RomLineVM {
    constructor(address) {
        this.current = __WEBPACK_IMPORTED_MODULE_0_knockout___default.a.observable(false);
        this.address = new __WEBPACK_IMPORTED_MODULE_2__RomLineAddress__["a" /* default */](address);
        let memories = [];
        for (let i = 0; i < 8; i++) {
            memories.push(new __WEBPACK_IMPORTED_MODULE_1__RomCellVM__["a" /* default */](false, address, i));
        }
        this.memories = memories;
    }
    ...
    getImmediateData() {
        return new __WEBPACK_IMPORTED_MODULE_3__domain_ImmediateData__["a" /* default */](parseMemoryToNumber(this.memories.slice().reverse().slice(0, 4)));
    }
...
/* harmony export (immutable) */ __webpack_exports__["a"] = RomLineVM;
...
class RomCellVM {
    constructor(initialValue, line, index) {
        this.value = __WEBPACK_IMPORTED_MODULE_0_knockout___default.a.observable(initialValue);
        this.line = line;
        this.index = index;
...
/* harmony export (immutable) */ __webpack_exports__["a"] = RomCellVM;
...
"use strict";
class RomLineAddress {
    constructor(address) {
        this.value = address;
        this.display = `00${address}`.slice(-2);
    }
}
/* harmony export (immutable) */ __webpack_exports__["a"] = RomLineAddress;
...
class ClockGeneratorVM {

  constructor(clockHandler) {
    this.clockHandler = clockHandler;
    this.clockTimer = 0;
    this.mode = __WEBPACK_IMPORTED_MODULE_0_knockout___default.a.observable(mode.Manual);
...
/* harmony export (immutable) */ __webpack_exports__["a"] = ClockGeneratorVM;
...
/* harmony export (immutable) */ __webpack_exports__["a"] = ResetOperationVM;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__OperationInput__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__OperationOutput__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Add__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Move__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__MoveFromRegister__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Jump__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__JumpIfNoCarry__ = __webpack_require__(21);
...
class OperationAggregation {
  constructor(registerA, registerB, input, output) {
    this.operations = new Map();
    this.operations.set(0, new __WEBPACK_IMPORTED_MODULE_2__Add__["a" /* default */](registerA));
    this.operations.set(5, new __WEBPACK_IMPORTED_MODULE_2__Add__["a" /* default */](registerB));
    this.operations.set(3, new __WEBPACK_IMPORTED_MODULE_3__Move__["a" /* default */](registerA));
    this.operations.set(7, new __WEBPACK_IMPORTED_MODULE_3__Move__["a" /* default */](registerB));
    this.operations.set(1, new __WEBPACK_IMPORTED_MODULE_4__MoveFromRegister__["a" /* default */](registerA, registerB));
    this.operations.set(4, new __WEBPACK_IMPORTED_MODULE_4__MoveFromRegister__["a" /* default */](registerB, registerA));
    this.operations.set(15, new __WEBPACK_IMPORTED_MODULE_5__Jump__["a" /* default */]());
    this.operations.set(14, new __WEBPACK_IMPORTED_MODULE_6__JumpIfNoCarry__["a" /* default */]());
    this.operations.set(2, new __WEBPACK_IMPORTED_MODULE_4__MoveFromRegister__["a" /* default */](registerA, input));
    this.operations.set(6, new __WEBPACK_IMPORTED_MODULE_4__MoveFromRegister__["a" /* default */](registerB, input));
    this.operations.set(9, new __WEBPACK_IMPORTED_MODULE_4__MoveFromRegister__["a" /* default */](output, registerB));
    this.operations.set(11, new __WEBPACK_IMPORTED_MODULE_3__Move__["a" /* default */](output));
  }

  run(operationCode, input) {
    const operation = this.operations.get(operationCode);
    if (operation) {
      return operation.run(input);
    } else {
      return new __WEBPACK_IMPORTED_MODULE_1__OperationOutput__["a" /* default */](false, input.clockCount + 1);
    }
  }
}
/* harmony export (immutable) */ __webpack_exports__["a"] = OperationAggregation;
...
class Add {
  ...
  run(input) {
    ...
    return new __WEBPACK_IMPORTED_MODULE_1__OperationOutput__["a" /* default */](addedValue >= 16, input.clockCount + 1);
  }
}
...
/* harmony export (immutable) */ __webpack_exports__["a"] = MoveFromRegister;
...
class Jump {
  run(input) {
    return new __WEBPACK_IMPORTED_MODULE_1__OperationOutput__["a" /* default */](false, input.data.value);
  }
}
...
class Jump {
  run(input) {
    return new __WEBPACK_IMPORTED_MODULE_1__OperationOutput__["a" /* default */](false, input.carry ? input.clockCount + 1 : input.data.value);
  }
}
/* harmony export (immutable) */ __webpack_exports__["a"] = Jump;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Setting__ = __webpack_require__(4);
...
function checkFlagLine(line) {
  return line === Flag.ON || line === Flag.OFF;
}

function checkMemoriesLine(lines) {
  return lines.find(s => !checkFlagLine(s)) ? false : true;
}

function convertFlagLine(line) {
...
/* harmony default export */ __webpack_exports__["a"] = ({
  fileToSetting: input => {
    ...
    return new __WEBPACK_IMPORTED_MODULE_0__Setting__["a" /* default */](hzMode, beep, memories);
  },

  settingToFile: setting => {
    const memoryStrings = setting.memories.map(m => m ? Flag.ON : Flag.OFF);
    const helzValues = setting.clockMode === '1Hz' ? [HzFlag.True, HzFlag.False, HzFlag.False] : setting.clockMode === '10Hz' ? [HzFlag.False, HzFlag.True, HzFlag.False] : [HzFlag.False, HzFlag.False, HzFlag.True];
