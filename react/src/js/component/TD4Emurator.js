...
import ClockModeValue from '../ClockModeValue'
import ChangeEvent from '../ChangeEvent'
import type {ChangeEventValue} from '../ChangeEventValue'
import {operate} from './Operation'

import type {TD4State, MemoryLine} from './TD4State'

export default class TD4Emurator extends React.Component<any, TD4State> {
  timer: ?number
  state: TD4State
  beep: (void) => void
  ...
  onChange(kind: ChangeEventValue, param: number | MemoryLine) {
    switch (kind) {
  ...
  onChangeClockMode(clockMode: ClockModeValue) {
    if (this.timer) {
